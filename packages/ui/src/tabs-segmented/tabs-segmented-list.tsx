...
import { TabsSegmentedIndicator } from "@/tabs-segmented/tabs-segmented-indicator"
import { normalizeWhitespace } from "@/utils/normalize-whitespace"
import styles from "@/tabs-segmented/tabs-segmented-list.module.css"

export interface TabsSegmentedListProps extends BaseTabs.List.Props {}

export function TabsSegmentedList(props: TabsSegmentedListProps) {
