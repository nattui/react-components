    ...
    <div className="flex flex-col">
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Popup className="fixed top-1/2 left-1/2 -mt-8 w-full max-w-448 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-gray-1 p-6 transition-all duration-150 data-ending-style:scale-90 data-starting-style:scale-90 data-ending-style:opacity-0 data-starting-style:opacity-0 dark:outline-gray-300">
