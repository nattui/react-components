          ...
          <div className="flex flex-col gap-y-8" key={sectionIndex}>
            ...
            <div className="flex flex-col gap-y-2">
              {section.links.map((link, linkIndex) => {
                ...
                return (
                  <Link
                    className="text-14 font-500 data-[is-active=true]:text-primary-9 hover:text-gray-12 hover:bg-gray-4! rounded-8 data-[is-active=true]:bg-gray-3 text-gray-11 relative flex h-28 w-full items-center px-8 transition-colors"
